...
_SEARCH_PHRASES = [
    "Открываю сейф. 36 вправо, 12 влево...",
    "Сдуваю пыль с папки «Особая важность».",
    "Если следят — моргните дважды в розетку.",
    "Лезу в архив на шаткую стремянку.",
    "Иду в секретный сектор «В»...",
    "Спускаюсь в бункер. Ловит только «Маяк».",
    "Ворочаю сейфы. Оставьте глоток чая.",
    "Споткнулся о сводки за 1979-й. Жив.",
    "У вас красивый почерк. Взял на карандаш.",
    "Кручу ручку стеллажа, как штурвал подлодки.",
    "Читаю вашу школьную характеристику...",
    "Скрепка впилась в палец. Спишем на травму.",
    "Ради вас нарушаю гостайну. Один раз.",
    "Кто убрал спецдокументы на верхнюю полку?!",
    "Проверяю документ на «жучки». Чисто.",
    "Тянусь за самой дальней папкой...",
    "Сохраню копию запроса в личный сейф.",
    "Почти отправил стеллаж в топку. Держусь.",
    "Расшифровываю: «Юстас — Алексу»… Не то.",
    "Печатаю на «Ундервуде». Застрял палец.",
    "В деле: «Объект обаятелен, продолжаем наблюдение».",
    "Опять залили шифровку чаем!",
    "Сверяю печати. Ищу гербовую.",
    "Найду сразу — с вас талон на спецпаёк.",
    "Стряхиваю пепел на гриф «Совершенно секретно».",
    "Резолюция: «арестовать» или «премировать»?",
    "Шлю привет морзянкой: тире-точка-точка...",
    "Ищу запрос, а мог бы ловить шпионов.",
    "В архиве пыльно, как в кино Тарковского.",
    "Достаю дело из-за портрета Дзержинского.",
    "Взламываю двойной шифр приказа...",
    "Работаю на пределе. Честное чекистское.",
    "Осторожно разлепляю страницы...",
    "Подмигиваю через скрытую в стене камеру.",
    "Товарищ майор спит. Ищу сам.",
    "Ставлю сургучную печать. Осторожно, горячо!",
    "Пытаюсь развязать тесёмки на папке...",
    "Перебираю перфокарты. Кто-то пролил кисель.",
    "Нашёл в деле талоны на колбасу за 1982-й.",
    "Ищу нужный абзац в море номенклатуры.",
    "Куда пропал стеллаж с грифом «М»?!",
    "Рискую погонами ради вашего ответа.",
    "Фонарик садится. Нагнетаю атмосферу!",
    "Смахиваю моль с секретного акта.",
    "Уверены? Обратного пути не будет.",
    "Страница вырвана! Ищу копию.",
    "Сверяю строчки по логарифмической линейке.",
    "На вкус эта бумага — чистый застой.",
    "Заполняю форму 4-Б. Порядок есть порядок.",
    "Достаю листок пинцетом. Без отпечатков.",
    "Читаю сквозь тушь. Похоже на ГОСТ колбасы.",
    "На допросе бы не выдал, что помогаю вам.",
    "Поправляю роговые очки. Что тут у нас...",
    "Если сейф упадёт — считайте меня коммунистом.",
    "Кручу ручку арифмометра «Феликс»...",
    "Включаю лампу с зелёным абажуром.",
    "Запрос в ЭВМ размером с квартиру. Ждём."
]
