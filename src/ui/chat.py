...
_SEARCH_PHRASES = [
    ...
    "Пытаюсь прочитать закрашенное черной тушью. Похоже на ГОСТ докторской колбасы.",
    ...
    "Включаю настольную лампу с зеленым абажуром. Так думать легче.",
...
def _handle_prompt(prompt: str, label: str | None = None) -> None:
    ...
    st.session_state.pending = {
        ...
        "phrases_html": "".join(
            ...
            for text in random.sample(_SEARCH_PHRASES, 20)
        ),
    }
